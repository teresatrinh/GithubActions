[![Run App Trinh, Teresa](https://github.com/teresatrinh/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/teresatrinh/GithubActions/actions/workflows/run-app.yaml)
